...
WHERE t.owner NOT IN (
    'APEX_050100','APEX_220100','ANONYMOUS','APEX_040200','APEX_PUBLIC_USER',
    'APPQOSSYS','AUDSYS','BI','CTXSYS','DBSNMP','DIP','DVF','DVSYS','EXFSYS',
    ...
    'OWBSYS','OWBSYS_AUDIT','APEX_030200','MGMT_VIEW','OJVMSYS',
    'DMSYS','OLAPSYS','PUBLIC','APEX_040000'
)
