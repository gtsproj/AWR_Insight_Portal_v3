...
CREATE INDEX IF NOT EXISTS ix_bl_samples_blid ON bl_samples USING btree (bl_id);
...
CREATE INDEX IF NOT EXISTS ix_wait_mv_snap ON wr_wait_summary_mv USING btree (dbname, instance, begin_snap);
