...
-- ALTER TABLE awr_sql_parse_calls  ADD COLUMN IF NOT EXISTS pdb_name TEXT;  -- table does not exist in this schema, skipped
-- ALTER TABLE awr_sql_sharable_mem       ADD COLUMN IF NOT EXISTS pdb_name TEXT;  -- table does not exist in this schema, skipped
-- ALTER TABLE awr_sql_version_count      ADD COLUMN IF NOT EXISTS pdb_name TEXT;  -- table does not exist in this schema, skipped
