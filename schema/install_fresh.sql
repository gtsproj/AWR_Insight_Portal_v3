...
-- Defined in anomaly_detector.py at runtime; included here
-- for a clean fresh installation.
-- ============================================================
CREATE TABLE IF NOT EXISTS sar_anomalies (
    ...
    object_name     TEXT,                   -- disk device or network interface name
    metric_value    NUMERIC,                -- observed value at snap_time
    baseline_mean   NUMERIC,               -- rolling mean over anomaly_baseline_days
    baseline_stddev NUMERIC,               -- rolling stddev over anomaly_baseline_days
